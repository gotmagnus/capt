...
async function main() {
  ...
  const shDefs: SH[] = [
    ...
    { key: "priya", name: "Priya Raman", email: "priya.raman@example.com", relationship: "FORMER_EMPLOYEE", title: "Co-founder (departed)", department: "Product", startDate: d(2022, 3, 15), terminationDate: d(2023, 7, 15), employmentStatus: "TERMINATED", costCenter: "R&D" },
    ...
    { key: "homebrew", name: "Homebrew Ventures", email: "homebrew@example.com", relationship: "INVESTOR", type: "ENTITY", accredited: true },
    { key: "lakeshore", name: "Lakeshore Partners", email: "lakeshore@example.com", relationship: "INVESTOR", type: "ENTITY", accredited: true },
    { key: "hustle", name: "Hustle Fund II, L.P.", email: "hustlefund@example.com", relationship: "INVESTOR", type: "ENTITY", accredited: true },
    { key: "rachel", name: "Rachel Kim", email: "rachel.kim@example.com", relationship: "INVESTOR", accredited: true, tags: ["Angel"] },
    { key: "tom", name: "Tom Alvarez", email: "tom.alvarez@example.com", relationship: "INVESTOR", accredited: true, tags: ["Angel"] },
    { key: "scout", name: "Sequoia Scout (Ana Petrova)", email: "ana.petrova@example.com", relationship: "INVESTOR", accredited: true, tags: ["Angel", "SAFE"] },
    { key: "svb", name: "Silicon Valley Bank", email: "venture.debt@example.com", relationship: "OTHER", type: "ENTITY", tags: ["Lender"] },
    ...
    { key: "advisor1", name: "Dr. Lena Fischer", email: "lena@example.com", relationship: "ADVISOR", title: "Technical advisor", country: "CH", costCenter: "R&D" },
    { key: "advisor2", name: "Marcus Hale", email: "marcus@example.com", relationship: "ADVISOR", title: "GTM advisor", costCenter: "S&M" },
    // employees
    ...
    { key: "carlos", name: "Carlos Mendes", email: "carlos.mendes@example.com", relationship: "FORMER_EMPLOYEE", title: "Sales Engineer", department: "Sales", startDate: d(2024, 1, 8), terminationDate: d(2025, 4, 30), employmentStatus: "TERMINATED", costCenter: "S&M" },
  ...
  // ------------------------------------------------------------- offer letters
  await db.offerLetter.create({ data: { companyId: C, candidateName: "Priyanka Desai", candidateEmail: "priyanka.desai@example.com", title: "Staff Software Engineer", department: "Engineering", level: "L6", salary: 215_000, equityQuantity: 90_000, equityType: "OPTION_ISO", strikePrice: 0.85, vestingScheduleId: vStd.id, startDate: d(2026, 10, 19), expiresAt: addDays(TODAY, 5), status: "SENT", createdAt: subDays(TODAY, 4), sentAt: subDays(TODAY, 3), viewedAt: subDays(TODAY, 2), createdById: maya.id, packages: JSON.stringify([{ label: "Balanced", salary: 215_000, equityQuantity: 90_000 }, { label: "More equity", salary: 195_000, equityQuantity: 130_000 }, { label: "More cash", salary: 235_000, equityQuantity: 55_000 }]), message: "We were blown away by your systems design interview. We'd love for you to lead our platform team." } });
  ...
  const acmeKai = await db.stakeholder.create({ data: { companyId: acme.id, name: "Kai Nguyen", email: "kai@example.com", relationship: "FOUNDER", title: "Founder" } });
  const acmeAngel = await db.stakeholder.create({ data: { companyId: acme.id, name: "Rachel Kim", email: "rachel.kim@example.com", relationship: "INVESTOR", accredited: true } });
